 ...
 *@env: local copy of env
 *@environ: modified copy of environ from LL environ
 *@history: history node
 *@alias:  alias node
 *@env_changed: if environ was changed on
 *@status: the return status of the last command
 *@cmd_buf: address of pointer to cmd_bufon if chaining
...
/**
 *struct builtin - with string and related function
